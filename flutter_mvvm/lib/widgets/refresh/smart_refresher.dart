...
import 'package:flutter_mvvm/widgets/refresh/classic_indicator.dart';
import 'dart:math' as math;

import 'package:flutter_mvvm/widgets/refresh/default_constants.dart';
import 'package:flutter_mvvm/widgets/refresh/footer_indicator.dart';
import 'package:flutter_mvvm/widgets/refresh/indicator_config.dart';
import 'package:flutter_mvvm/widgets/refresh/indicator_wrap.dart';
import 'package:flutter_mvvm/widgets/refresh/refresh_physics.dart';
  ...
  void _handleOffsetCallback() {
    ...
    if (_scrollController.position.pixels ==
      ...
      if (widget.enablePullUp == true &&
          widget.controller._footerMode.value != RefreshStatus.noMore) {
        // 让footer 出现
